...
def analyze_soil_and_biochar():
    crops = Crop.query.all() # Fetch all crops for the dropdown menu
    messages = {}
    data = None
    soil_data = {}
    ...
    if request.method == 'POST':
        ...
        soil_data = {
            ...
            "SMP buffer pH": request.form.get("SMP buffer pH"),
    ...
    return render_template('sdi_search_location5.html', soil_data=soil_data, messages=messages, crops=crops, crop_data=data, biochar_results=biochar_results, biochars=closest_biochars, soil_type = soil_type)
