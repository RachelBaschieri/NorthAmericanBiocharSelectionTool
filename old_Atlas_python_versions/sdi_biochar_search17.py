...
# Fetch all priorities from the database
    ...
    # Gather soil data
        ...
        if selected_biochar:
            ...
            selected_biochar_details = None
        return render_template('sdi_biochar_search17.html', priority_results=priority_results, soil_data=soil_data, messages=messages, lime_message=lime_message, crops=states, crop_data=data, biochar_results=biochar_results, soil_type = soil_type, moisture_message=moisture_message, organic_matter_message = organic_matter_message, priority_list=priority_list, selected_biochar = selected_biochar, selected_biochar_details = selected_biochar_details, amendment_rec_render = amendment_rec_render, show_priorities_form=False)
