...
def analyze_soil_and_biochar():
    ...
    return render_template('sdi_search_location3.html', soil_data=soil_data, messages=messages, crops=crops, crop_data=data, biochar_results=biochar_results, biochars=closest_biochars)
