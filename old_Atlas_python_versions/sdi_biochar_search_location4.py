...
def analyze_soil_and_biochar():
    ...
    return render_template('sdi_search_location4.html', soil_data=soil_data, messages=messages, crops=crops, crop_data=data, biochar_results=biochar_results, biochars=closest_biochars, soil_type = soil_type)
